// 引入对应的服务层
import * as RoleService from '../../service/admin/RoleService.js';
...
export async function createOrUpdateRoleWithSelectedRoutesMethod(req, res) {
    await handleServiceCall(RoleService.createOrUpdateRoleWithSelectedRoutes, req, res);
}
export async function getRoutesForRoleMethod(req, res) {
    await handleServiceCall(RoleService.getRoutesForRole, req, res);
}
